...
const tableTheme = {
  ...
  */
  buttons: {
    ...
    danger:
      "border-red-200 bg-red-50 px-3 text-red-600 hover:bg-red-100",
  ...
  */
  cell: {
    class:
      "px-5 py-4 text-sm text-[#041124] align-middle",
  ...
  */
  export: {
    button:
      "border-[#628891]/30 bg-white px-3 text-[#041124] hover:bg-[#628891]/10",
  ...
  */
  columnManager: {
    ...
    menu:
      "w-64 rounded-xl border border-slate-200 bg-white p-3 shadow-xl",

    menuHeader:
      "mb-2 flex items-center justify-between border-b border-slate-100 pb-2",

    title:
      "text-sm font-semibold text-[#041124]",

    resetButton:
      "text-xs font-medium text-[#628891] transition hover:text-[#041124]",
  ...
  */
  empty: {
    icon:
      "flex h-12 w-12 items-center justify-center rounded-xl bg-[#628891]/10",
