...
return [
    ...
    */
    ...
    'columnManager' => [
        ...
        'menu' => 'w-64 rounded-xl border border-slate-200/80 bg-white p-3 shadow-xl ring-1 ring-black/5 animate-in fade-in slide-in-from-top-2 duration-200',

        'menuHeader' => 'mb-2.5 flex items-center justify-between border-b border-slate-100 pb-2',

        'title' => 'text-xs font-bold uppercase tracking-wider text-slate-400',

        'resetButton' => 'text-xs font-semibold text-[#628891] transition-colors duration-150 hover:text-[#041124]',

        'list' => 'max-h-60 space-y-0.5 overflow-y-auto pr-1 scrollbar-thin',

        'item' => 'flex cursor-pointer items-center gap-2.5 rounded-lg px-2 py-2 text-sm font-medium text-[#041124] transition-colors duration-150 hover:bg-slate-50',

        'itemActive' => 'bg-slate-50/50',

        'label' => 'text-sm font-medium text-[#041124]/90',

        'checkbox' => 'h-4 w-4 cursor-pointer rounded border-slate-300 text-[#628891] focus:ring-[#628891]/20 transition-all duration-150',
